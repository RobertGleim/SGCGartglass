          ...
          <div className="woodwork-form-field">
            ...
            <div className="woodwork-image-upload-section">
              ...
              <div className="woodwork-image-upload-input">
                ...
                <span className="woodwork-form-note">Add up to 10 photos and 1 video. If upload is too large, reduce the number of photos/videos.</span>
                {uploadWarning && <span className="woodwork-form-note" style={{ color: '#c62828' }}>{uploadWarning}</span>}
              </div>
