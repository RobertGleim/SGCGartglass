    ...
    <div className="stainedglass-modal-overlay" onClick={onClose}>
      <div className="stainedglass-modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="stainedglass-modal-header">
          ...
          <button 
            className="stainedglass-modal-close" 
            onClick={onClose}
            aria-label="Close"
          >
            ×
        ...
        <form className="stainedglass-modal-form" onSubmit={handleSubmit}>
          <label>
            Product Name *
            <input
              type="text"
              ...
              placeholder="Enter stained glass product name"
              required
            />
          </label>

          <div className="stainedglass-form-field">
            <label>Images / Video</label>
            <div className="stainedglass-image-upload-section">
              <div className="stainedglass-watermark-section">
                <h4>Watermark Settings</h4>
                <div className="stainedglass-watermark-controls">
                  <label className="stainedglass-checkbox-label">
                    <input
                      type="checkbox"
                  ...
                  {enableWatermark && (
                    <div className="stainedglass-watermark-input-group">
                      <label>
                        Watermark Text
                        <input
                          type="text"
                      ...
                      <span className="stainedglass-form-note">
              ...
              <div className="stainedglass-image-upload-input">
                <input
                  type="file"
                  id="stainedglass-image-input"
                  accept="image/*,video/*"
                  multiple
              ...
              {imagePreviews.length > 0 && (
                <div className="stainedglass-image-gallery">
                  <h4>Added Images ({imagePreviews.length})</h4>
                  <div className="stainedglass-image-grid">
                    {imagePreviews.map((preview) => (
                      <div 
                        key={preview.id} 
                        className="stainedglass-image-item"
                        onClick={(e) => e.stopPropagation()}
                      >
                        {preview.type === 'video' ? (
                          <video src={preview.src} className="stainedglass-image-preview" />
                        ) : (
                          <img src={preview.src} alt="Preview" className="stainedglass-image-preview" />
                        )}
                        <button
                          type="button"
                          className="stainedglass-remove-image-btn"
                          onClick={(e) => {
                            e.stopPropagation()
                        ...
                        {preview.type === 'video' && (
                          <span className="stainedglass-media-badge">Video</span>
                        )}
                      </div>
                    ))}
                  </div>
          ...
          <label>
            Categories
            <div className="stainedglass-multi-select-wrapper">
              <div className="stainedglass-multi-select-inner">
                <div className="stainedglass-multi-select-row">
                  <select
                    value=""
                    onChange={(e) => {
                    ...
                    className="stainedglass-multi-select-dropdown"
                  >
                  ...
                  <button
                    ...
                    title="Add category"
                    className="stainedglass-multi-select-add-btn"
                  >
                    + Add
                  </button>
                </div>
                <input
                  ...
                  className="stainedglass-multi-select-input"
                />
                {manualProduct.category.length > 0 && (
                  <div className="stainedglass-multi-select-tags">
                    {manualProduct.category.map((cat) => (
                      <div
                        key={cat}
                        className="stainedglass-category-tag"
                      >
                        {cat}
                        <button
                          type="button"
                          ...
                          className="stainedglass-category-tag-remove"
                        >
                          ✕
                        </button>
                      </div>
                ...
                {manualProduct.materials.length > 0 && (
                  <div className="stainedglass-multi-select-tags">
                    {manualProduct.materials.map((mat) => (
                      <div
                        key={mat}
                        className="stainedglass-material-tag"
                      >
                        {mat}
                        <button
                          type="button"
                          ...
                          className="stainedglass-material-tag-remove"
                        >
                          ✕
                        </button>
                      </div>
          ...
          <div className="stainedglass-size-inputs">
            <label>
              Width (inches)
              <input
                type="number"
          ...
          <div className="stainedglass-price-quantity-inputs">
            <label>
              Price *
              <input
                type="number"
          ...
          <div className="stainedglass-modal-actions">
            <button type="button" className="stainedglass-button" onClick={onClose}>
              Cancel
            </button>
            <button type="submit" className="stainedglass-button stainedglass-primary">
