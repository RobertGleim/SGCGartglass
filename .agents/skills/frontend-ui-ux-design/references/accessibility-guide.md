...
1. **Placeholder as label** GÂ∆ Always provide label
2. **Removing focus outline** GÂ∆ Provide alternative
3. **Click div/span** GÂ∆ Use button/link
4. **Color-only indicators** GÂ∆ Add icon/text
5. **Low contrast text** GÂ∆ Increase contrast
6. **Auto-playing media** GÂ∆ Provide controls
7. **Small touch targets** GÂ∆ Minimum 44x44px
8. **Keyboard traps** GÂ∆ Allow escape
9. **Missing alt text** GÂ∆ Describe image
10. **Generic link text** GÂ∆ Be descriptive
