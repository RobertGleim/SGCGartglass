...
1. **Fixed widths** GÂ∆ Use percentages or max-width
2. **Viewport meta tag missing** GÂ∆ Add `<meta name="viewport">`
3. **Desktop-first approach** GÂ∆ Start mobile-first
4. **Too many breakpoints** GÂ∆ Keep it simple (3-4 max)
5. **Neglecting touch targets** GÂ∆ Minimum 44x44px
6. **Ignoring landscape** GÂ∆ Test both orientations
7. **Large image files** GÂ∆ Optimize and use srcset
8. **Horizontal scroll** GÂ∆ Use max-width: 100%
